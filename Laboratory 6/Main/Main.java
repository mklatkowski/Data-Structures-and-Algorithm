...
//        ShakerSort<Double> shaker = new ShakerSort<>(comp1);
        ...
        ListSorter<Double> merge = new MergeSort<>(comp1);
        ListSorter<Double> quick = new QuickSort<>(comp1);
        ListSorter<Double> heap = new HeapSort<>(comp1);

        ArrayList<Double> list = generateList(1000, 100);
        ArrayList<Double> list1 = generateList2(1000);
            ArrayList<Double> list2 = generateList3(1000);

//        System.out.println("Rozmiar listy: 1000");
//        System.out.println("Typ ciągu: posortowany");
//        System.out.println(" ");
//
        sortList(merge, list2);
        sortList(quick, list2);
        sortList(heap, list2);
